...
import com.ryderbelserion.cluster.api.commands.ExtraContext;
import com.ryderbelserion.cluster.bukkit.BukkitPlugin;
import com.ryderbelserion.cluster.bukkit.commands.args.CommandArgs;
...
public class CommandContext extends ExtraContext implements CommandArgs {
    ...
    private final boolean isLegacy = this.bukkitPlugin.isLegacy();
    ...
    public void sendMessage(String message) {
        this.sender.sendMessage(LegacyUtils.parse(message));
    }
    ...
    public Player getArgAsPlayer(int index, boolean notifySender, String message) {
        Player player = this.plugin.getServer().getPlayer(getArgs().get(index));
